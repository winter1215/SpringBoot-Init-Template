package com.tower.portal.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.tower.common.config.exception.GlobalException;
import com.tower.common.config.redis.RedisCache;
import com.tower.common.enums.AuthStatus;
import com.tower.common.enums.ErrorCode;
import com.tower.common.enums.RedisPrefix;
import com.tower.common.model.dto.UpdateUserDto;
import com.tower.common.model.pojo.User;
import com.tower.common.mapper.UserMapper;
...
import com.tower.portal.service.IUserCacheService;
import com.tower.portal.service.IUserService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.tower.security.util.JwtTokenUtil;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public UserDetails loadUserByUsername(String username) {
        ...
        return new TowerUserDetails(user);
    }
    /**
    ...
    public R updatePassword(String oldPassword, String newPassword) {
        TowerUserDetails user = SecurityUtils.getLoginObj();
        if(user == null){
